...
// read(function(books){//books代表所有的图书
//     console.log(books);
// });
...
http.createServer((req,res)=>{
    ...
    let {pathname,query}=url.parse(req.url,true);//true把query转换为对象
            ...
            case 'POST':
                ...
                req.on('end',()=>{
                    ...
                    read(function(books){//添加id
                        ...
                        books.push(book);//将数据放到books中books在内存中
                    ...
                    req.on('end',()=>{
                        ...
                        read(function(books){
                            books=books.map(item=>{
                                ...
                                return item;//返回其他正常的书
                            });
                            write(books,function(){//将数据写入json中
                                res.end(JSON.stringify(book));
                            });
                        });
                    })
